 <?php
   ...
   $con = mysqli_connect('vcg.isti.cnr.it','cignoni',$dbpassword,'archive');
    ...
    echo "ID;COGNOME;NOME;EMAIL;CELLULARE;TELEFONO;CAP;INDIRIZZO;CITTA';ID_COABITA\n";
    while($row = mysqli_fetch_array($result)) {
        echo $row['id_utente'].";".$row['cognome'].";".$row['nome'].";".$row['email'].";".$row['cellulare'].";".$row['telefono'].";".$row['CAP'].";".$row['indirizzo'].";".$row['citta'].";".$row['id_coabita']."\n"; 
    }
?>